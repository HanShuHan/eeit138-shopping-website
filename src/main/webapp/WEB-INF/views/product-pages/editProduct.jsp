...
<div class="container border">
    <form:form method="POST" modelAttribute="product" enctype="multipart/form-data">
        ...
        <form:input type="number" id="price" path="price" placeholder="產品價錢" required="required" min="1" max="99999"
                    autocomplete="off"/><br>
        ...
        <form:textarea type="text" name="detail1" id="detail1" path="detail1" placeholder="產品敘述 1"
                       required="required" autocomplete="off"/><br>
        <label for="detail2">產品敘述 2:</label>
        <form:textarea type="text" name="detail2" id="detail2" path="detail2" placeholder="產品敘述 2"
                       required="required" autocomplete="off"/><br>
