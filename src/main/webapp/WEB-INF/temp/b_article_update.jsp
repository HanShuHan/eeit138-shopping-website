                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="form" action="${contextRoot}/editArticle"
                                    ...
                                    <br>
                                    <form:input class="form-control" required="required" value="${post.posttitle}"
                                                path="Posttitle"/>
                                    <p/><br>
                                    <label>內容</label><br>
                                    <form:textarea id="postcontent" required="required" name="postcontent"
                                                   value="${post.postcontent}" path="Postcontent"/>
                                    <script>
