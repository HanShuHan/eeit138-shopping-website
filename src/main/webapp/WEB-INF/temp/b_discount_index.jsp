                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <h5>活動目錄</h5>
                                    <hr>
                                    <div class="box"><a href="${contextRoot}/viewFixeds">固定金額折扣活動</a></div>
                                    <div class="box"><a href="${contextRoot}/viewPercentages">優惠折扣活動</a></div>
                                    <div class="box"><a href="${contextRoot}/viewCoupons">優惠碼管理</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
