            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">訂單列表</h5><br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm" id="table_id">
                                        ...
                                        <c:forEach var="OrderBean" items="${OrderBeans}">
                                            <tr>
                                                <td>
                                                    <a href="${contextRoot}/oneOR?id=${OrderBean.merchantTradeNo}">${OrderBean.merchantTradeNo}</a>
                                                </td>
                                                <td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                    value="${OrderBean.merchantTradeDate}"></fmt:formatDate></td>
                                                <td>${OrderBean.totalAmount}</td>
                                                <td>${OrderBean.tradeDesc}</td>
                                                <td>${OrderBean.rtnMsgL}</td>
                                                <td>
                                                    <div>
                                                        <a class="btn btn-sm btn-danger"
                                                           href="${contextRoot}/bordelete?id=${OrderBean.merchantTradeNo}"
