                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-sm btn-primary"
                                   href="${contextRoot}/updateAccountBean?id=${AccountBean.acid}">更新</a>
                                <br><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <p><fmt:formatDate pattern="yyyy/MM/dd"
                                                       value="${AccountBean.birth}"></fmt:formatDate><br><br>
                                        <label>電話：</label>
                                    <p><c:out value="${AccountBean.phone}"></c:out><br><br>
                                        <label>註冊時間：</label>
                                    <p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                       value="${AccountBean.added}"></fmt:formatDate><br><br>
                                        <label>修改時間：</label>
                                    <p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                       value="${AccountBean.updated}"></fmt:formatDate><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
