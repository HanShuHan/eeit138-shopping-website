            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div>請新增折扣活動(固定折抵金額)</div>
                                <div>
                                    <form:form action="${contextRoot}/addPercentages"
                                        ...
                                        <div>
                                            ...
                                            <form:input path="percentageTime" id="datepicker"
                                                        name="percentageTime" autocomplete="off" onblur="checkTM()"/>
                                            <span id="tmsp" style="font-size: 10px;"></span>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <form:input path="percentage" id="percentage"
                                                        onblur="checkA()"/>
                                            <label>折</label> <span id="psp" style="font-size: 10px;"></span>
                                        </div>
                                        <span id="sbstr" style="font-size: 10px;"></span>
                                        <button type="submit" name="submit"
                                                onsubmit="return checkSubit()">新增
                                        </button>
                                        <a href="${contextRoot}/viewPercentages">
