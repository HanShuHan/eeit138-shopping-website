            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <a class="btn btn-sm btn-primary" href="${contextRoot}/badindex">返回</a>
                                <a class="btn btn-sm btn-primary"
                                   href="${contextRoot}/updateAdminBean?id=${AdminBean.id}">更新</a>
                                <br><br>
                                ...
                                <div class="form-group">
                                    <label>姓名：</label>
                                    <p><c:out value="${AdminBean.name}"></c:out><br><br>
                                        <label>電話：</label>
                                    <p><c:out value="${AdminBean.phone}"></c:out><br><br>
                                        <label>性別：</label>
                                    <p><c:out value="${AdminBean.gender}"></c:out><br><br>
                                        <label>地址：</label>
                                    <p><c:out value="${AdminBean.position}"></c:out><br><br>
                                        <label>服務門市：</label>
                                    <p><c:out value="${AdminBean.location}"></c:out><br><br>
                                        <label>管理等級：</label>
                                    <p><c:out value="${AdminBean.rank}"></c:out><br><br>
                                        <label>註冊時間：</label>
                                    <p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                       value="${AdminBean.added}"></fmt:formatDate><br><br>
                                        <label>修改時間：</label>
                                    <p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                       value="${AdminBean.updated}"></fmt:formatDate><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
