            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="${contextRoot}/baradd">
                                    <button>新增文章</button>
                                </a><br>
                                <hr>
                                <h5 class="card-title">文章列表</h5><br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm" id="table_id">
                                        ...
                                        <c:forEach var="posts" items="${posts}">
                                            <tr>
                                                <td><a href="${contextRoot}/oneAR?id=${posts.id}"><c:out
                                                        value="${posts.posttitle}"></c:out></a></td>
                                                <td><c:out value="${posts.type}"></c:out></td>
                                                <td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                    value="${posts.added}"></fmt:formatDate></td>
                                                <td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                    value="${posts.updated}"></fmt:formatDate></td>
                                                <td>
                                                    <div>
                                                        <a class="btn btn-sm btn-danger"
                                                           href="${contextRoot}/deletePost?id=${posts.id}"
