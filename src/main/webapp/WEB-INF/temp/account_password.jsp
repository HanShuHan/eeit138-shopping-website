...
<div class="container border padding-10" id="login-div">
    <nav>
        <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
            <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
               aria-controls="nav-profile" aria-selected="false">更改密碼</a>
        </div>
    </nav>
    <div class="tab-content border border-top-0" id="nav-tabContent">
        <div class="tab-pane fade show active padding-10" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <form name="cpw" onsubmit="return validate()" action="${contextRoot}/cpassword?id=${sessionScope.accountId}"
                  method="Post">
                <div class="form-group">
                    <label>請輸入舊密碼</label>
                    <input type="password" class="form-control" name="pwd" id="pwd" placeholder="請輸入密碼"
                           onblur="checkPW()" required="required" value="${passWord}"/>
                    <span id="pwsp" style="font-size: 10px;"></span>
                </div>
                <div class="form-group">
                    <label>請輸入新密碼</label>
                    <input type="password" class="form-control" name="npwd" id="npwd" placeholder="請輸入密碼"
                           onblur="checkNPW()" required="required"/>
                    <span id="npwsp" style="font-size: 10px;"></span>
                </div>
                <div class="form-group">
                    <label>密碼再確認</label>
                    <input type="password" class="form-control" name="pwdcheck" id="pwdcheck" placeholder="請再次確認"
                           onblur="checkPWR()" required="required"/>
