    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="profile-head">
                ...
                <p class="proile-rating">註冊日期 : <span><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                          value="${AccountBean.added}"></fmt:formatDate></span>
                </p>
            </div>
        </div>
        <div class="col-md-2">
            <a href="${contextRoot}/updateAc?id=${AccountBean.acid}">
