                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-sm btn-primary" href="${contextRoot}/barindex">返回</a>
                                <a class="btn btn-sm btn-primary"
                                   href="${contextRoot}/editArticle?id=${post.id}">更新</a>
                                <hr>
                                <br>
                                <h3><c:out value="${post.posttitle}"></c:out></h3>
                                <label>類型：</label><c:out value="${post.type}"></c:out>
                                |<label>最後更新時間：</label><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                             value="${post.updated}"></fmt:formatDate><br><br>
