                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="speak px-lg-5">
                                            ...
                                            <form:form class="form"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <form:textarea path="replymessage"
                                                                   class="form-control border" rows="5"
                                                                   required="required"></form:textarea>
                                                </div>
                                                <button type="submit"
                                                        class="mt-3 btn btn-success btn-block py-3">送出
                                                </button>
                                            </form:form>
                                        </div>
                                    ...
                                    <div class="media py-5">
                                        <div class="media-body">
                                            ...
                                            <span>送出時間：<fmt:formatDate
                                                    ...
                                                    value="${reply.added}"></fmt:formatDate></span>
                                    ...
                                    <a class="btn btn-sm btn-primary" href="${contextRoot}/breindex">返回</a>
                                </div>
                            </div>
                        </div>
                    </div>
