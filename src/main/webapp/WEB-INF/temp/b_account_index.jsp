            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">會員列表</h5><br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm" id="table_id">
                                        ...
                                        <c:forEach var="account" items="${accounts}">
                                            <tr>
                                                <td><a href="${contextRoot}/oneAC?id=${account.acid}"><c:out
                                                        value="${account.ac}"></c:out></a></td>
                                                <td><c:out value="${account.aname}"></c:out></td>
                                                <td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                    value="${account.added}"></fmt:formatDate></td>
                                                <td>
                                                    <div>
                                                        <a class="btn btn-sm btn-danger"
                                                           href="${contextRoot}/deleteAC?id=${account.acid}"
