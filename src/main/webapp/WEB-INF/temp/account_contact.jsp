        ...
        <div class="speak px-lg-5">
                    ...
                    <form:form class="form" action="${contextRoot}/cusReply?id=${sessionScope.accountId}"
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 form-group p-0">
                                ...
                                <form:input path="title" type="text" class="form-control border"
                                            required="required"></form:input>
                            </div>
                            <label for="contactcomment">內容：</label>
                            <form:textarea path="message" class="form-control border" rows="5"
            ...
            <c:forEach var="replys" items="${replys}">
                <div class="media py-5">
                    ...
                    <img width="80" src='<c:url value="/acimage/${sessionScope.accountId}"/>'
                         class="mr-3 img-fluid rounded-circle" alt="image">
                    <div class="media-body">
                        <h5 class="mt-0">${sessionScope.ac}</h5>
                        <h6 class="mt-0">${replys.title}</h6>
                        <span>送出時間：<fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                       value="${replys.added}"></fmt:formatDate></span>
                            ...
                            <div class="media-body">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <p class="mt-2">回復於：<fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss"
                                                                               value="${replys.replyadded}"></fmt:formatDate></p>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
