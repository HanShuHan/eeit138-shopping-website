                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <form:form action="${contextRoot}/addFixeds"
                                        ...
                                        <div>
                                            ...
                                            <form:input path="fixedTime" id="datepicker"
                                                        name="fixedTime" autocomplete="off" onblur="checkTM()"/>
                                        </div>
                                        <div>
                                            <form:radiobutton path="fixedOnOff" value="1"/>
                                            開始活動
                                            <form:radiobutton path="fixedOnOff" value="0" checked="true"/>
                                            關閉活動
                                        </div>
                                        <div>
