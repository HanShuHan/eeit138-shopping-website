                            ...
                            <div class="card-body">
                                ...
                                <div class="container border">
                                    ...
                                    <a href='<c:url value="/editProduct?productId=${product.productId}"/>'>
                                        <button class="btn btn-success" style="position: absolute; right: 150px;">修改
                                        </button>
                                    </a>
                                    <a href="${contextRoot}/bprindex">
                                        <button class="btn btn-secondary" style="position: absolute; right: 90px;">
                                            返回
                                        </button>
                                    </a>
                                    <p><b>狀態: <span style="color: orange;">${product.productStatus.status}</span></b>
                                    </p>
                                    <p><b>價錢: <span style="color: red;">$${product.price} 新台幣</span></b></p>
                                    <p><b>類別: <span style="color: green;">${product.category.type}</span></b></p>
                                    <b>關於此商品</b>
                                    <ul>
                                    ...
                                    <!-- 											<a -->
                                    <%-- 												href='<c:url value="/editProduct?productId=${product.productId}"/>'> --%>
                                    <!-- 												<button class="btn btn-success">修改</button> -->
                                    <%-- 											</a> <a href="${contextRoot}/bprindex"><button class="btn btn-secondary"> --%>
                                    <!-- 												返回</button></a> -->
                                    <!-- 										</div> -->
